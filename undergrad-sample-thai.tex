...
\hline
Exception:         & \multicolumn{2}{l|}{\begin{tabular}[c]{@{}l@{}}User จะไม่สามารถผูก Real Asset กับพินัยกรรมที่ถูกสร้างขึ้นมาบน platform ได้ \\จำเป็นต้องผูกกับพินัยกกรมที่ถูก upload เข้ามาเท่านั้น\end{tabular}}                                                            \\
\hline
\end{tabular}
}
\end{table}
...
\hline
Use Case
  Name:     & \multicolumn{2}{l|}{Delete Asset}                                                                                                                                                                                                                                                                                                                                                     \\ 
\hline
Actors:              & \multicolumn{2}{l|}{User}                                                                                                                                                                                                                                                                                                                                                             \\ 
\hline
...
\hline
Flow of
  Event:     & \begin{tabular}[c]{@{}l@{}}1.เลือกเมนู Delete Asset \\\\3.เลือกสินทรัพย์และหลักฐานการเป็นเจ้าของที่อยู่ในระบบ \\4.ลบสินทรัพย์และหลักฐานการเป็นเจ้าของในระบบ \\5.ยืนยันการลบสินทรัพย์และหลักฐานการเป็นเจ้าของในระบบ\\\\\end{tabular} & \begin{tabular}[c]{@{}l@{}}2.ระบบทำการแสดงสินทรัพย์ที่ถูกบันทึกในระบบ  \\\\\\6.ทำการนำสินทรัพย์และหลักฐานการเป็นเจ้าของออกจากระบบ\end{tabular}  \\ 
\hline
Exception:           & \multicolumn{2}{l|}{~}                                                                                                                                                                                                                                                                                                                                                                \\
\hline
\end{tabular}
...
\hline
Flow of
  Event:     & \begin{tabular}[c]{@{}l@{}}1.เลือกเมนู View Asset \\\\3.เลือกสินทรัพย์ที่ถูกบันทึกไว้ในกระเป๋าเงินที่ต้องการดู \\~ ~\end{tabular} & \begin{tabular}[c]{@{}l@{}}2.ระบบทำการสินทรัพย์ที่ถูกบันทึกไว้ในกระเป๋าเงิน \\\\4.ทำการแสดงสินทรัพย์ที่ถูกบันทึกไว้และหลักฐานการเป็นเจ้าของสินทรัพย์นั้นให้ User\end{tabular}  \\ 
\hline
Exception:           & \multicolumn{2}{l|}{~}                                                                                                                                                                                                                                                                                             \\
\hline
\end{tabular}
...
\subsection{Sequence Diagram}
	...
	\item Create Will
		...
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{createWillseq}
...
\end{table}
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{viewWillseq}
...
\end{table}
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{viewRealAssetseq}
...
\end{table}
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{checkStatusDeathseq}
...
\end{table}
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{createRealAssetseq}
...
\end{table}
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{createDigitalAssetseq}
...
และมีปุ่ม “เพิ่มสินทรัพย์” เพื่อไปยังหน้าของการเพิ่มสินทรัพย์
		...
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.25]{saveAsset}
		...
		\item หน้ารายชื่อคนรับมรดก
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.25]{heirAccount}
			\caption{หน้าบันทึกสินทรัพย์}
		\end{figure}
		\FloatBarrier
		...
		\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.25]{displayAsset}
