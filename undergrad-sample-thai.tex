...
\subsection{Profile Page}
	\begin{figure}[!thb]
		...
		\end{figure}
		\FloatBarrier
\tab จากรูปหลังจากคลิก โปร์ไฟล์ ที่ nav bar
...
\subsection{Create Will Page }
	\begin{figure}[!thb]
		...
		\end{figure}
		\FloatBarrier
\tab จากรูปหลังจากคลิกบันทึกพินัยกรรม
...
\subsection{Manage Will Page}
	\begin{figure}[!thb]
		...
		\end{figure}
		\FloatBarrier
\tab จากรูปหลังจากคลิกจัดการพินัยกรรม

\subsection{Add Real Assets }
	\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{addRealPage4}
			\caption{Add Real Assets Page}
		\end{figure}
		\FloatBarrier
\tab จากรูปหลังจากคลิกเพิ่มสินทรัพย์จริง

\subsection{Loading Add Real Assets }
	\begin{figure}[!thb]
			\centering
			\includegraphics[scale=0.2]{addRealLoadingPage4}
			\caption{Loading Add Real Assets}
		\end{figure}
		\FloatBarrier
