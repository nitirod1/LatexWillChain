...
\tab คือโทเค็นการระบุตัวตนดิจิทัลที่แสดงถึงลักษณะ คุณลักษณะ และความสำเร็จที่ประกอบขึ้นเป็นบุคคลหรือนิติบุคคล SBT ออกโดย “Souls” ซึ่งเป็นตัวแทนของบัญชีบล็อคเชนหรือกระเป๋าเงิน และไม่สามารถโอนได้
...
\tab Hardhat เป็นสภาพแวดล้อมสำหรับการพัฒนาบน Ethereum ที่ช่วยให้นักพัฒนาสามารถจัดการและทำงานที่เกิดซ้ำโดยอัตโนมัติซึ่งมีอยู่ในการสร้างสมาร์ทคอนแทรคและ DApps โดย Hardhat สามารถโต้ตอบโดยตรงกับ Ethereum API ของ Moonbeam ดังนั้นจึงสามารถใช้เพื่อปรับใช้กับสมาร์ทคอนแทรคใน Moonbeam ได้
